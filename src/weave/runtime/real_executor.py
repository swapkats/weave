"""Real execution engine with LLM, plugin, and tool integration."""
...
from .executor import AgentOutput, ExecutionSummary


class RealExecutor:
    """
    Real agent execution engine with LLM, tool, and plugin support.
